...
namespace ToT_Adventure
{
    public class LoadGameScreen : Screen
    {
        ...
        {
            UI mMenuUI = new UI();
            UIItem mMenuUII = new UIItem("loadgame", Toolbox.UIItemType.TextFix, "Load Game", new UIAction(), Toolbox.Font.logo01, Toolbox.TextAlignment.TopLeft);
